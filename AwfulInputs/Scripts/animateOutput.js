function animateOutput(id){
    ...
    if (output.attr("data-is-visible") == 'true') {
        output.fadeOut(500, function () {
            output.empty();
            if (output.attr("data-format-status") == "success") { output.removeClass("output-error"); output.addClass("output-success"); }
            if (output.attr("data-format-status") == "error") { output.removeClass("output-success"); output.addClass("output-error"); }
